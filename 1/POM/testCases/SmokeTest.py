...
class LoginPageTest(LoginPage, HomePage):
...
class HomePageTest(LoginPage, HomePage):
    baseURL = "https://www.saucedemo.com/"
    standard_user = "standard_user"
    ...
    def test_ElementsOfLandingPageVisible(self):
        ...
        self.assertEqual(True, hp.isTitleEnable())
        ...
        for item in range(1, items + 1):
            ...
            self.assertEqual(True, hp.isDescriptionVisible(item), "Item description invisible")
    ...
    def test_ElementsInHamburgerMenuVisible(self):
        ...
        self.assertEqual(True, hp.isAboutVisible(), "About page is invisible")
        self.assertEqual(True, hp.isLogOutVisible(), "Logout page is invisible")
        self.assertEqual(True, hp.isResetAppVisible(), "Reset App page is invisible")
