...
class HomePage:
    ...
    button_add_to_cart_class_xpath = '//button'
    button_add_to_cart_class_class = "btn_inventory"
    ...
    def countMethodsSort(self):
        return self.driver.find_element(By.XPATH, self.dropdown_sort_xpath)
    ...
    def isItemsVisible(self):
        return self.driver.find_element(By.CLASS_NAME, self.div_items_class)

    def isImageItemVisible(self, index):
        return self.driver.find_element(By.XPATH, self.div_items_xpath + '[' + str(
            index) + ']' + self.div_item_image_xpath).is_displayed()
    ...
    def getSocialLinks(self):
        return self.driver.find_element(By.XPATH, self.links_social_xpath)

    def getAddToCartButtons(self):
        return self.driver.find_element(By.CLASS_NAME, self.button_add_to_cart_class_class)

    def clickImage(self, index):
        self.driver.find_element(By.XPATH,
                                 self.div_items_xpath + '[' + str(index) + ']' + self.div_item_image_xpath).click()

    def getImageSRC(self, index):
        return self.driver.find_element(By.XPATH,
                                        self.div_items_xpath + '[' + str(
                                            index) + ']' + self.div_item_image_xpath + "//img").get_attribute("src")

    def getItemName(self, index):
        return self.driver.find_element(By.XPATH, self.div_item_name_xpath + '[' + str(index) + ']').get_attribute(
            "textContent")

    def getItemPrice(self, index):
        return self.driver.find_element(By.XPATH,
                                        "(" + self.div_item_price_xpath + ')[' + str(index) + ']').get_attribute(
            "textContent")
